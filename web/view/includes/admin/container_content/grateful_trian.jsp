                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.pos" />Vị trí</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.parentPos" />Vị trí cha</label></a></li>
                                    <li><a><label><input type="checkbox" value="cus_.userName" checked />Username NPP</label></a></li>
                                    <li class="divider"></li>
