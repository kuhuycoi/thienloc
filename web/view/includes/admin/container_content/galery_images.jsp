            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="top" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.name" />Tên ảnh</label></a></li>
                                    <li><a><label><input type="checkbox" value="galeryId_.name" />Tên Album</label></a></li>
                                    <li class="divider"></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="btn-open-modal btn-sm btn btn-default" controller="<c:url value='${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}${PAGINATION.VIEW_INSERT}'/>">Thêm mới <i class="fa fa-newspaper-o"></i></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
