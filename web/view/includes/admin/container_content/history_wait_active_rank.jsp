                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.peoplesIdentity" />Số CMND</label></a></li>
                    ...
                    <div class="navbar-form navbar-right">
                        <div class="form-group">
                            ...
                            <select class="form-control change-date" controller="<c:url value="${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}/ChangeStatus/"/>">
                                <option value="-1" ${PAGINATION.accepted==null?'selected':''}>-- Tất cả --</option>
                                <option value="0" ${PAGINATION.accepted==false?'selected':''}>Chưa duyệt</option>
                                <option value="1" ${PAGINATION.accepted==true?'selected':''}>Đã duyệt</option>
                            </select>
                        </div>
                    </div>
                </div><!-- /.navbar-collapse -->
