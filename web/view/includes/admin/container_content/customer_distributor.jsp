                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="top" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.userName" checked />Tên Đăng Nhập</label></a></li>
                        ...
                        <div class="navbar-form navbar-right">
                            <div class="form-group">
                                ...
                                <select class="form-control change-date" controller="<c:url value="${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}/ChangeAgency/"/>">
                                    <option value="-1" ${PAGINATION.agencyId==null?'selected':''}>-- Tất cả --</option>
                                    <c:forEach items="${f:findAllAvailableProvincialAgencies()}" var="pro">
                                        <option value="${pro.id}" ${PAGINATION.agencyId==pro.id?"selected":""}>${pro.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
