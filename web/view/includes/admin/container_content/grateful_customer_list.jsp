            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn" data-toggle="tooltip" data-placement="left" data-title="Lựa chọn các trường tìm kiếm">
                                ...
                                <ul class="dropdown-menu dropdown-select dropdown-menu-left">
                                    ...
                                    <li><a><label><input type="checkbox" value="this_.userName" checked />Username NPP</label></a></li>
                                    <li><a><label><input type="checkbox" value="this_.pinCode" />Mã PIN</label></a></li>
                                    <li class="divider"></li>
                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        <div class="form-group form-group-sm">
                            <label class="control-label">Có mã PIN: </label>
                            <div class="input-group ">
                                <select class="form-control change-time" controller='<c:url value="${PAGINATION.ROOT_CONTROLLER}${PAGINATION.childrenController}${PAGINATION.grandController}/HasPinCode/"/>'>                                        
                                    <option value="-1" ${PAGINATION.hasPinCode==null?"selected":""}>-- Tất cả --</option>
                                    <option value="1" ${PAGINATION.hasPinCode!=null&&PAGINATION.hasPinCode?"selected":""}>Đã có mã PIN</option>
                                    <option value="0" ${PAGINATION.hasPinCode!=null&&!PAGINATION.hasPinCode?"selected":""}>Chưa có mã PIN</option>
                                </select>
                            </div>
                        </div>
                    </div>
