...
<div class="modal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="form-insert" class="form-insert form-horizontal" novalidate method="POST" action="${pageContext.servletContext.contextPath}/Admin/Galery/GaleryList/Edit">
                <input type="hidden" value="${GALERY.id}" name="id" />
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="control-label col-sm-2">Tên Album <i>(*)</i></label>
                        <div class="col-sm-10">
                            <input type="text" required class="form-control" id="name" name="name" value="${GALERY.name}" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" readonly name="titleImg" class="form-control" id="titleImg" value="${GALERY.titleImg}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">Hiển thị</label>
                        <div class="col-sm-10">
                            <input type="checkbox" name="isShow" checked="true" ${GALERY.isShow?'checked':''} />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="orderNumber" class="control-label col-sm-2">Thứ tự</label>
                        <div class="col-sm-10">
                            <input type="number" name="orderNumber" min="1" value="${GALERY.orderNumber}" id="orderNumber" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="shortDescription" class="control-label col-sm-2">Mô tả</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="shortDescription" name="shortDescription" value="${GALERY.shortDescription}" />
                        </div>
                    </div>
                </div>
